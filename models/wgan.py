...
class WGAN(LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.discriminator = ConvDiscriminator(
            num_channels=self._channels,
            feature_map_sz=discriminator_feature_map_size,
            sigmoid=False,
        )
    ...
    def training_step(self, batch, batch_idx):
        ...
        errD_real = self.adversarial_loss(output)
        ...
        errD_fake = self.adversarial_loss(output)
        ...
        if (batch_idx + 1) % self.n_discriminator_steps == 0:
            ...
            errG = self.adversarial_loss(output)
